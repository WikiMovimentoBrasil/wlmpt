...
const colorTriples = [
    ...
    ["#F542D4", "#660053", "#FFFFFF"],
    ["#34B2D9", "#004E66", "#FFFFFF"],
    ["#FFFFFF", "#000000", "#000000"]
]

const regions = ["AC", "AL", "AG", "C", "LI", "MA", "N"]
            ...
            d === regions[2] ? colorTriples[2][0] :
                d === regions[3] ? colorTriples[3][0] :
                    d === regions[4] ? colorTriples[4][0] :
                        d === regions[5] ? colorTriples[5][0] :
                            d === regions[6] ? colorTriples[6][0] :
                                colorTriples[7][0];
}
            ...
            d === regions[2] ? colorTriples[2][1] :
                d === regions[3] ? colorTriples[3][1] :
                    d === regions[4] ? colorTriples[4][1] :
                        d === regions[5] ? colorTriples[5][1] :
                            d === regions[6] ? colorTriples[6][1] :
                                colorTriples[5][1];
}
            ...
            d === regions[2] ? colorTriples[2][2] :
                d === regions[3] ? colorTriples[3][2] :
                    d === regions[4] ? colorTriples[4][2] :
                        d === regions[5] ? colorTriples[5][2] :
                            d === regions[6] ? colorTriples[6][2] :
                                colorTriples[5][2];
}
